  <div class="container">
    <a href="#demo" class="btn btn-lg btn-block btn btn-success" data-toggle="collapse">Nuevo Alumno</a>
    <div id="demo" class="collapse">
        <div class="form">
            <div class="card card-body">
                <form action="Alumnos\guardarAlumno.php" method="POST" enctype="multipart/form-data">
